...
class QuotexAPI(object):
    def __init__(self,
        ...
        :param str cookies: The cookies used for authentication.
        :param str lang: The language for the Quotex platform.
        :param proxies: The proxies for the Quotex server (optional).
        :param user_data_dir: The path to the browser user data directory.
        """
        self.host = host
        self.https_url = f"https://{host}"
        self.wss_url = f"wss://ws2.{host}/socket.io/?EIO=3&transport=websocket"
        self.cookies = cookies  # Ensure cookies are passed here
    ...
    async def authenticate(self):
        ...
        status, message = await self.login
          self.cookies,  # Only pass cookies for authenticatio
